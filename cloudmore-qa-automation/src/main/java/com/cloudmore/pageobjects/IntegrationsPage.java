...
public class IntegrationsPage extends BasePage {
    private String integrationsPageBannerText = "//*[@class='banner-text']//h1[contains(text(),'Integrations')]";
    @Override
    public boolean isPageAvailable() {
        return isElementVisible(getLocator(integrationsPageBannerText,BY_TYPE.BY_XPATH),4);
    }
    @Override
